...
<div class="flex flex-wrap bg-gray-100 w-full h-screen">
    <div class="w-2/12 bg-gary-900  p-3 shadow-lg ">
        ...
        {{-- <div class="space-x-4 p-2 mb-8 flex flex-wrap">
          <h1 class="font-semibold text-2xl mt-10 capitalize font-poppins tracking-wide">Date </h1>
          <img class="h-7 w-10 mt-10 " src="{{asset('/images/calendar.png')}}" alt="La meteo">   
        </div> --}}
    ...
    <footer class="bg-gray-800 mt-4 px-0 py-1 dark:bg-gray-800 w-full fixed bottom-0">
        <div class="flex flex-wrap">
            {{-- <div class="w-2/12 mx-auto max-w-screen-xl md:flex md:items-center md:justify-between">
                <img src="{{asset('/images/logo.png')}}" alt="FSM-UMI" srcset="" class=" h-12 ">
            </div> --}}
            <div class="w-full">
