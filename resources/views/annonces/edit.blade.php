    ...
    <div class="w-full max-w-lg m-x-6">
        <form method="POST" action="{{ route('annonces.update', $annonce) }}" class="bg-white shadow-lg rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="flex items-center justify-between mt-4 ">
                <a href="{{ route('annonces.index') }}" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline no-underline ">Retourne</a>
