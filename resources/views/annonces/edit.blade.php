...
<div class="flex justify-center mt-8">
    <div class="w-3/4">
        <form method="POST" action="{{ route('annonces.update', $annonce) }}" class="bg-white shadow-lg rounded px-16 pt-6 pb-8 mb-4">
            @csrf
            @method('PUT')
			      <h2 class="text-center font-bold text-3xl mb-3">Edit Annonce</h2><hr>
            <div class="mb-4">
